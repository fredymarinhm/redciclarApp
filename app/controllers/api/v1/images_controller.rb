module Api
    module V1
        class ImagesController < ApiApplicationController
            ...
            def index
                images = Image.order('created_at DESC').where user_id: current_user.id
            ...
            def create 
                ...
                if image.save 
                    ...
                    render json: {status: 'ERROR', message: 'imagen no guardada', data: image}, status: :unprocessable_entity #Error proceso creación
                end
            end
            ...
            def update 
                ...
                if image.update_attributes(image_params)
                    ...
                    render json: {status: 'ERROR', message: 'imagen no editada', data: image}, status: :unprocessable_entity #Error proceso creación
                end
            end
